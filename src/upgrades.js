...
export const CARDS = [
  ...
  {
    id: 'whip_gravity_slam',
    label: 'GRAVITY SLAM',
    desc: 'Whip pulls enemies toward you for 1.5× damage instead of knocking back',
    rarity: 'legendary',
    legendaryUnique: 'whip',
    requires: 'whip',
    icon: 'G',
    apply: player => { _weapon(player, 'whip').gravitySlamOnHit = true },
  },
  {
    id: 'whip_boomerang',
    label: 'BOOMERANG WHIP',
    desc: 'Each whip swing returns 0.35s later for a second hit at 75% damage',
    rarity: 'legendary',
    legendaryUnique: 'whip',
    requires: 'whip',
    icon: 'B',
    apply: player => { _weapon(player, 'whip').boomerang = true },
  },
  {
    id: 'whip_orbit_blades',
    label: 'ORBIT BLADES',
    desc: 'Each whip swing fires 4 outward blades in cardinal directions at 50% damage',
    rarity: 'legendary',
    legendaryUnique: 'whip',
    requires: 'whip',
    icon: '+',
    apply: player => { _weapon(player, 'whip').orbitBlades = true },
  },
  {
    id: 'wand_explode',
    label: 'ARCANE BURST',
...
export function pickSparklyCards(player, n) {
  const eligible = CARDS.filter(card => {
    ...
    // legendaryUnique filter temporarily disabled
