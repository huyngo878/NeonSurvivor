...
export const ENEMY_TYPES = {
  ...
  tank:      { speed: 55,  hp: 120,  maxHp: 120,  radius: 20, color: '#ff4400', damage: 20, gemValue: 3,  gemRadius: 8,  gemColor: '#ffd700', moneyValue: 2  },
  speedster: { speed: 220, hp: 18,   maxHp: 18,   radius: 8,  color: '#ff44ff', damage: 8,  gemValue: 1,  gemRadius: 6,  gemColor: '#00ffff', moneyValue: 1  },
  brute:     { speed: 35,  hp: 280,  maxHp: 280,  radius: 25, color: '#aa00ff', damage: 35, gemValue: 6,  gemRadius: 10, gemColor: '#cc88ff', moneyValue: 3  },
  boss:      { speed: 70,  hp: 2500, maxHp: 2500, radius: 42, color: '#ffcc00', damage: 40, gemValue: 20, gemRadius: 12, gemColor: '#ffffff', moneyValue: 12 },
}
